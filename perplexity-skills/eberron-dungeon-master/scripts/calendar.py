...
campaign files live under GM_CAMPAIGN_ROOT (default
/home/user/workspace/campaigns/) and the display-companion send.py hook has
been removed.
...
def cmd_events(campaign: str) -> None:
    ...
    if not events:
        ...
        print("  Add events by editing your campaigns/<name>/calendar.json")
