...
files and updates XP.

Adapted from Bobby-Gray/open-tabletop-gm (AGPL-3.0-or-later) to run standalone:
character files live under GM_CAMPAIGN_ROOT (default
/home/user/workspace/campaigns/<campaign>/characters/) and the display-sidebar
...
# ── Path resolution ───────────────────────────────────────────────────────────
# Standalone: campaign character files live under GM_CAMPAIGN_ROOT.
