...
- **In-world date:** <Day, Month, Year — canonical source; keep in sync above>
  - *Eberron default (Galifar calendar): 12 months of 28 days = 336-day year. Months in order: Zarantyr, Olarune, Therendor, Eyre, Dravago, Nymm, Lharvion, Barrakas, Rhaan, Sypheros, Aryth, Vult. Week = Sul, Mol, Zol, Wir, Zor, Far, Sar. Era: YK ("Year of the Kingdom"); default campaign start 998 YK. Twelve moons plus the Ring of Siberys overhead.*
