...
## Campaign Tone & Genre
- **Setting:** Eberron (default) — pulp/noir wide-magic world; the Last War just ended (Treaty of Thronehold, 996 YK). Override only if the player asks for a different setting.
- **Tone:** <noir / pulp-adventure / intrigue / grimdark / heroic / horror / political / swashbuckling / cosmic> *(Eberron default: morally grey noir-pulp)*
- **Magic level:** <none / low / medium / high> *(Eberron default: high — magic is industrialized: lightning rail, elemental airships, everyday cantrips, House Cannith fabrication)*
- **Setting type:** <medieval / renaissance / ancient / nautical / underground> *(Eberron default: dieselpunk-renaissance)*
- **Danger level:** <lethal / gritty / standard / heroic>
- **Premise:** <the campaign in one sentence — what it's fundamentally about>

> Consult `lore/` (the canonical lorebook) for nations, dragonmarked houses, religions, factions, and races before filling this file. Use `scripts/lore_search.py` and cite sources.

### Eberron Anchors (fill from lore/)
- **Dragonmarked houses in play:** <e.g. Cannith, Sivis, Orien, Kundarak, Phiarlan, Thuranni, Deneith, Vadalis, Tharashk, Jorasco, Ghallanda, Lyrandar, Medani>
- **Nation(s) / region:** <e.g. Breland, Thrane, Aundair, Karrnath, Cyre (Mournland), Zilargo, Droaam, Darguun, the Eldeen Reaches, Sharn>
- **Faiths active:** <Sovereign Host, Silver Flame, Blood of Vol, Cults of the Dragon Below, the Path of Light, the Undying Court, Druidic sects>
- **Last War fallout:** <local scars, refugees, warforged veterans, the Mournland's edge, Emerald Claw activity>
